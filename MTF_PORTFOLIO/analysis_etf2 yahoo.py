...
def sell_stock(row, holding: pd.DataFrame, signal='sell'):
    ...
    if stock_name in holding['stock'].values:
        ...
        if holding_signal == 'buy':            
            ...
            PER_STOCK_INVEST += round((profit / 200), 2)
...
if __name__ == '__main__':
    start_date = 'etf2'
    input_file = 'MTF_PORTFOLIO/data_yahoo/total_etf_data.csv'
    output_file = f'MTF_PORTFOLIO/portfolio_analysis_yahoo_{start_date}.csv'
